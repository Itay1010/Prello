        ...
        <section className='task-details flex col' onClick={(event) => event.stopPropagation()}>
            ...
            <div className='task-container flex space-between'>
                ...
                <div className='task-edit flex col'>
                    ...
                    <div className='modal-btn btn-edit-task-key flex align-center' onClick={() => setModal('checklist')}>
                    ...
                    <div className='modal-btn btn-edit-task-key flex align-center' onClick={() => setModal('attachment')}>
                    ...
                    <div className='modal-btn btn-edit-task-key flex align-center' onClick={ev => {
