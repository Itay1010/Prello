...
export const BoardData = ({ board, saveBoardHeader }) => {
    ...
    return <section className="board-data flex align-center">
        ...
        {/* <TextareaAutosize
            ...
            style={{ width: 200 }}
        /> */}
        <TxtInputCmp isBoardTitleEditable={isBoardTitleEditable} toggleContentEditable={toggleBoardTitleEditable} saveFunc={saveBoardHeader} contentInitialState={board.title} />
