...
export const BoardData = ({ board, saveBoardHeader }) => {
    ...
    return <section className="board-data flex align-center">
        ...
        {/* <div>{board.title}</div> */}
        {!isBoardTitleEditable && <h2 onClick={toggleBoardTitleEditable}>{board.title}</h2>}
        {isBoardTitleEditable && <TxtInputCmp isBoardTitleEditable={isBoardTitleEditable} toggleBoardTitleEditable={toggleBoardTitleEditable} saveBoardHeader={saveBoardHeader} boardInitialTitle={board.title} />}
