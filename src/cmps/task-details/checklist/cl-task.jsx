...
export const ClTask = ({ deleteClTask, item, setIsDone, checklistId, boardMembers, generalTask, saveMemberToClTask }) => {
    ...
    return <div className='cl-task-wrapper'>
        ...
        <div className='cl-task'>
            ...
            <div className={`cl-task-buttons ${item.member ? 'open' : ''}`}>
            ...
            {isModalOpen && <div className='modal checklist-members'><Members saveMemberToCl={onSaveClMembers} boardMembers={boardMembers} task={generalTask} closeModal={toggleModal} type={'checklist'} /> </div>}
        </div>
    </div>
}