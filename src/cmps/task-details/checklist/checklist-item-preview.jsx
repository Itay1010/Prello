...
export const ChecklistItemPreview = ({ item, saveChecklistTask, setIsDone, checklistId, deleteClTask, deleteChecklist, boardMembers }) => {
    ...
    return <div className='checklist-item-preview'>
        ...
        <div className='item-content flex'>
            ...
            <div className='checklist-item-list'>
                {items?.length > 0 && <ClItemsList checklistId={checklistId} items={items} setIsDone={setIsDone} deleteClTask={onDeleteClTask} boardMembers={boardMembers} />}
