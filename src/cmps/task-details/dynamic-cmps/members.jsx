        ...
        <section className='members'>
            ...
            {membersToDisplay.map(currMember => {
                return <div className='member flex space-between align-center' onClick={() => toggleMember(currMember._id)} key={currMember._id}>
                    ...
                    {!type && task.members.includes(currMember._id) && <svg viewBox="0 0 24 24"><path d="M19,5.2L8.5,15.8c-0.3,0.3-0.8,0.3-1.1,0L5,13.3c-0.5-0.5-1.2-0.5-1.6,0l0,0c-0.5,0.5-0.5,1.2,0,1.6l3.8,3.8 c0.5,0.5,1.2,0.5,1.6,0L20.7,6.9c0.5-0.5,0.5-1.2,0-1.6l0,0C20.2,4.8,19.5,4.8,19,5.2z" /></svg>}
                </div>
            })}
        </section >
    )
