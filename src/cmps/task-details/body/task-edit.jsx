...
export const TaskEdit = (props) => {
    ...
    return <div className='task-edit flex col'>
        ...
        <div className='modal-btn btn-edit-task-key flex align-center' >
            <div className='flex btn-wrapper align-center' onClick={() => setModalType('members')}>
        ...
        <div className='modal-btn btn-edit-task-key label flex align-center'>
            <div className='flex btn-wrapper align-center' onClick={() => setModalType('labels')}>
        ...
        <div className='modal-btn btn-edit-task-key flex align-center'>
            <div className='flex btn-wrapper align-center' onClick={() => setModalType('checklist')}>
                <IChecklist />
                <p>Checklist</p>
            </div>
        ...
        <div className='modal-btn btn-edit-task-key flex align-center'>
            <div className='flex btn-wrapper align-center' onClick={() => setModalType('attachment')}>
        ...
        <div className='modal-btn btn-edit-task-key flex align-center'>
            <div className='flex btn-wrapper align-center' onClick={ev => {
                props.onArchiveTask({ [props.taskId]: [props.task.id], [props.groupId]: [props.group].id })
